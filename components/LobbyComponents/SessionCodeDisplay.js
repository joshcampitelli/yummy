...
export default function SessionCodeDisplay(props) {
    ...
    const searchRadiusSlider = props.host ? <LabeledSlider min={props.minRadius} max={props.maxRadius} unit="km" handleValueChange={props.handleRadiusChange}></LabeledSlider> : null;
